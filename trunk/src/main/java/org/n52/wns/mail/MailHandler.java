...
public class MailHandler implements IMailHandler {
	...
	private static Logger log = LoggerFactory.getLogger(MailHandler.class.getName());
	...
	/* (non-Javadoc)
	 * @see org.n52.wns.mail.IMailHandler#sendNotificationMessage(net.opengis.wns.x00.DoNotificationDocument, java.lang.String[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.n52.wns.mail.IMailHandler#sendExternalMessage(java.lang.String, java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.n52.wns.mail.IMailHandler#setProperties(org.x52North.wns.WNSConfigDocument.WNSConfig.RegisteredHandlers.EMailHandler)
	 */
