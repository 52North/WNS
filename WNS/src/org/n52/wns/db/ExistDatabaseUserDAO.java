...
public class ExistDatabaseUserDAO implements UserDAO {
	...
	private static Logger log = Logger.getLogger(ExistDatabaseUserDAO.class
			.getName());

	/**
	 * This is the constructot and inits the USER DAO database
	 * 
	 * @param properties
	 * @throws WNSException
	 */
	public ExistDatabaseUserDAO(DataBaseProperties properties)
		...
		try {
			...
			log.fatal("Error during init ExistDatabaseUserDAO request: "
					+ e.toString());
