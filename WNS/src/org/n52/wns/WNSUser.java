...
import org.x52North.wns.WNSUserDocument.WNSUser.MultiUser.User.AssociatedUsers;
...
public class WNSUser {
	...
	public WNSUser(
			org.x52North.wns.WNSUserDocument.WNSUser.SingleUser.User userArray) {
	...
	public WNSUser(
			org.x52North.wns.WNSUserDocument.WNSUser.MultiUser.User userArray) {
		this.userID = Long.parseLong(userArray.getID());
		this.multiUser = true;
	...
	public AssociatedUsers getAssociatedUsers() {
		if (this.isMultiUser()) {
			org.x52North.wns.WNSUserDocument.WNSUser.MultiUser.User user = org.x52North.wns.WNSUserDocument.WNSUser.MultiUser.User.Factory
					.newInstance();
