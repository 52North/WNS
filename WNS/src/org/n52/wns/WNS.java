...
public class WNS extends HttpServlet {
	...
	private Logger log = Logger.getLogger(WNS.class.getName());
...
//      props.list(System.out);
		...
		try {
         ...
         try {
            ...
            if (!isValid) {
               ...
               this.initParams = WNSInitParamContainer
               .createInstance(wnscd);
            }             
			...
			this.log.fatal("Could not initialise WNS.",e);
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			this.log.fatal("An exception occurred while handling Get request: "
					+ e.getMessage(),e);
			...
			try {
				...
				this.log.fatal("The exception could not be sent: "
						+ e.getMessage(),e);
			}
		}
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			this.log
					.fatal("An exception occurred while handling Post request: "
							+ e.getMessage(),e);
