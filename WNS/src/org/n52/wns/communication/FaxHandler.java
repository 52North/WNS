...
/**
 * Interface to define methods to send messages via fax
 * 
...
public interface FaxHandler {

	/**
	 * sets the configuration properties of the Fax handler
	 * 
	 * @param faxHandler
	 *            The Faxhandler element
	 */
	public void setProperties(
			WNSConfigDocument.WNSConfig.RegisteredHandlers.FaxHandler faxHandler);

	/**
	 * sends a Notification message using a Fax handler
	 * 
	 * @param dnd
