...
public class FaxHandlerFactory {
	...
	private static Logger log = Logger.getLogger(FaxHandlerFactory.class
			.getName());
	...
	public static FaxHandler getInstance(
			org.x52North.wns.WNSConfigDocument.WNSConfig.RegisteredHandlers.FaxHandler faxHandler)
			throws WNSServiceException {
