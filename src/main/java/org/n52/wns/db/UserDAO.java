...
public interface UserDAO {
	...
	/**
	 * Returns the user document of the WNS.
	 * 
	 * @return The user document of the WNS.
	 * 
	 * @throws WNSException
	 *             If the user document could not be retrieved.
	 */
	WNSUserDocument getUserDocument() throws WNSException;

	/**
	 * Persists the given user document.
	 * 
	 * @param wnsud
	 ...
	 */
	void storeWNSUserDocument(WNSUserDocument wnsud) throws WNSException;
}
