...
public class WNSDatabaseThread implements Runnable {
	...
	private XMLHashTableDocument xmlhash = XMLHashTableDocument.Factory.newInstance();

	private SimpleDateFormat format = new SimpleDateFormat("yyyyMMddHHmmss");

	private static Logger log = LoggerFactory.getLogger(WNSDatabaseThread.class);
	...
	public synchronized void add(String id, GDuration duration) throws WNSException {
		...
		XMLHashTableDocument.XMLHashTable.Hash hash = this.xmlhash
