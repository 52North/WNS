 ...
 * @version 2.0
 */
public interface WNSMessageHandlerI {

	public DoNotificationResponseDocument doNotification(
			DoNotificationDocument dnd) throws WNSServiceException;

	public GetMessageResponseDocument getMessage(GetMessageDocument gmd)
